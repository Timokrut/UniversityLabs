...
// Ввести строку и слово. Найти пару слов, разница длин которых максимальна. Из этой пары слов, минимальное по длинне заменить на слово, которое ввел пользователь.
